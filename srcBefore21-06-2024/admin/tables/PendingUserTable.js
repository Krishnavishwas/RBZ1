    ...
    const columns = [
...

        {
            ...
            cell: row => <> <Link to="" className="me-2"
                onClick={() => handleUpdate(row.userID)}><i className="bi bi-pencil-square"></i></Link>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-md-6">
                                                <div className="form-bx mb-4">
                                                    ...
                                                    <label>
                                                        {/* <select name="bankID" className="" aria-label="Large select example" onChange={(e) => { changeUpdateForm(e) }} value={updateData?.bankID} >
                                            ...
                                            {bankoptionValue?.map((item) => {
                                                ...
                                                return (
                                                    <option value={item.id} >{item.bankName}</option>
                                                        ...
                                                        <input type="text" placeholder="Bank name" className="" name="bankID" aria-label="Large select example" disabled onChange={(e) => { changeUpdateForm(e) }} value={updateData?.bankName} />
                                                        <span className='sspan'></span>
                                                    </label>
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-6">
                                                        <div className="form-bx mb-4">
                                                            ...
                                                            <label>
                                                                <select name="defaultID" className="" aria-label="Large select example" onChange={(e) => { changeUpdateForm(e) }} value={updateData?.defaultID}>
