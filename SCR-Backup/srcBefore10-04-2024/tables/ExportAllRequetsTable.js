  ...
  const tabHeader = (
    <div className="application-tab w-100 mt-4">
      <ul class="nav nav-pills mb-3">
        <li class="nav-item">
          <a class={tabDepId == 'All' ? "nav-link active" : "nav-link"} onClick={() => handleClickTag('All')}>All Request ({tabCount?.allDataCount})</a>
        </li>
        <li class="nav-item">
          <a class={tabDepId == 'My' ? "nav-link active" : "nav-link"} onClick={() => handleClickTag('My')}>My Request ({tabCount?.myDataCount})</a>
        </li>
      </ul>
    </div>
  );
