...
const ExportPendingRequestsTable = () => {
  ...
  //------tabs state start
  const [tabDepId, setTabDepId] = useState("My");
        ...
        <>
          ...
          <div>
            <div className="application-tab w-100 mt-4">
              ...
              <li class="nav-item">
                  <a class={tabDepId == 'All' ? "nav-link active" : "nav-link"} onClick={(e) => handleClickTag('All')}>All Pending</a>
                </li>
                <li class="nav-item">
                  <a class={tabDepId == 'My' ? "nav-link active" : "nav-link"} onClick={(e) => handleClickTag('My')}>My Pending</a>
                </li>
