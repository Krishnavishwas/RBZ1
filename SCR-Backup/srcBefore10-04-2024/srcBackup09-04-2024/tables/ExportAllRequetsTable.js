...
const ExportAllRequetsTable = () => {
  ...
  const action = (rowData) => {
    ...
    return (
      <>
        ...
        ></i>
        {rowData.status == 10 || rowData.status == 30 || rowData.status == 40 || rowData.status == 25 ?
          (loader == rowData?.id ? (
            <TailSpin
              visible={true}
              height="20"
  ...
  console.log("ExportsapproveRequests", ExportsapproveRequests.length);
            ...
            <>
              ...
              <div>
                <div className="application-tab w-100 mt-4">
                  ...
                  <li class="nav-item">
                      <a class={tabDepId == 'All' ? "nav-link active" : "nav-link"} onClick={(e) => handleClickTag('All')}>All Request </a>
                    </li>
                    <li class="nav-item">
                      <a class={tabDepId == 'My' ? "nav-link active" : "nav-link"} onClick={(e) => handleClickTag('My')}>My Request </a>
                    </li>
