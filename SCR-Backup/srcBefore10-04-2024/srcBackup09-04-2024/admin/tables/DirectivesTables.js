...
const DirectivesTables = () => {
  ...
  console.log("directiveTag - ", directiveTag);
  ...
  console.log("fileu - ", Filesu);
  console.log("labelChange -", labelChange);
  ...
  const DeleteFile = async (id) => {
    if (window.confirm("Are you sure you want to delete this Image?")) {
      const result = Filesu.filter((data) => data.id !== id);
      SetFilesu(result);
    } else {
      alert("No");
    }
  ...
  //     if (enteredValue && !val.includes(enteredValue) && !val.includes("")) {
          ...
          <div className="login_inner">
            ...
            <div className="login_form_panel">
              <Modal.Body className="p-0">
                ...
                <div className="kb-file-upload mt-2">
