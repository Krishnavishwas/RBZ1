...
const ExportDashboardTable = () => {
  ...
  const renderHeader = () => {
    return (
      <div className="d-flex justify-content-between align-items-center">
        ...
        {roleID >= 5 ? (
          <div className="form-footer mt-0 d-block text-end bulkdelegateBtn">
            <button
              type="button"
              onClick={() => handleClickDelegateModal()}
              className="login"
  ...
  console.log("delegateValues" , delegateValues);

  const delegateSubmit = () => {
    setBtnLoader(true);
    axios
        ...
        <>
          {loading == true ? (
            ...
            <div>
              ...
              >
                {roleID >= 5 ? (
                  <Column selectionMode="multiple" style={{ width: "40px" }} exportable={false}></Column>
                ) : (
                  ""
                )}
                <Column
                    ...
                    <div className="row">
                      <div class="col-md-12">
                        <div class="inner_form_new">
                          <label class="controlformV">User</label>
                          <div class="form-bxV">
                            <label>
                              <select
                                name="AssignUserID"
                      ...
                      <div class="col-md-12">
                        <div class="inner_form_new">
                          <label class="controlformV">Notes</label>
                          <div class="form-bxV">
                            <label>
                              <textarea
                      ...
                      <div class="col-md-12">
                        <div class="inner_form_new">
                          <label class="controlformV">Comments</label>
                          <div class="form-bxV">
                            <label>
                              <textarea
