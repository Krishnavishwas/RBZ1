      ...
      {roleID > 3 ? (
        <>
          ...
          <div className={banksuperTab ? "customtab" : "d-none"}>
            {allcomment.length ? allcomment?.map((cur) => {
                ...
                if (cur?.assignedToRoleID == 3) {
                  return (
                    <>
                      ...
                      <div className={item?.notes ? "inner_form_new " : "d-none"}>
                      ...
                      <div className={item?.comment ? "inner_form_new " : "d-none"}>
            ...
            }) :  <div className={banksuperTab ? "customtab" : "d-none"}><p className="text-center">No Record Found</p></div>}
          </div>
        </>
      ) : (
        ""
