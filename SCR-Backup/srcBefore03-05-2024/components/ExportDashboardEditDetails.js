      ...
      axios
          ...
          .then((response) => {
            ...
            if (response.data.responseCode === "200") {
              ...
              const refpdfview = roleID == 3 && nextlevelvalue == 10 ? PdfPrivewsupervisorRef : (roleID == 3 && nextlevelvalue == '') ? CoverigLetterRef :PdfPrivewRef;
                  ...
                  >
                    <table width="100%">
                      ...
                      <tr>
                        ...
                        >
                          Dear {applicationDetail?.companyName == null || applicationDetail?.companyName == ""
                                  ? applicationDetail?.name
                                  : applicationDetail?.companyName}, 
