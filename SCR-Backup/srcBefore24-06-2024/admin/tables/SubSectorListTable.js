                    ...
                    subHeaderComponent={
                        <div className="admintablesearch">
                            ...
                            <div className="filtet-sector">
                                <label>
                                    <select name="SectorID" className="" aria-label="Large select example" onChange={(e) => handleSector(e)}>
                        ...
                        <div className="login_form_panel">
                            <Modal.Body className="p-0">
                                ...
                                {/* <div className="form-bx mb-2">
                                    ...
                                    {errors === true && !sectorMasterForm.SectorName ? <small className="errormsg">SectorName is Required</small> : ''}
                                </div> */}
                                <div className="form-bx mb-4">
                                    <label>
                                        <select name="SectorID" className="" aria-label="Large select example" onChange={(e) => { changeHandelForm(e) }}>
                        ...
                        <div className="login_form_panel">
                            <Modal.Body className="p-0">
                                {/* <div className="form-bx mb-3">
                                    ...
                                    {errors === true && !updateData.sectorCode ? <small className="errormsg">Title is Required</small> : ''}
                                </div> */}
                                <div className="form-bx mb-4">
                                ...
                                <div className="form-bx mb-4">
                                    ...
                                    <label>
                                        <select name="sectorID" className="" aria-label="Large select example" onChange={(e) => { changeUpdateForm(e) }} value={updateData.sectorID}>
                                            <option value="" selected>Select Sector Name</option>
                                            {
                                                sectorData?.map((item) => {
                                                    return (
