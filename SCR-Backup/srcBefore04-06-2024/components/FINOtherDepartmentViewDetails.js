...
const FINOtherDepartmentViewDetails = ({
  applicationDetail,
  handleFormClose,
  allcomment,
  tatHistory,
      ...
      {showdataLoader == true || !noDataComment?.length ? (
        ...
        <>
          ...
          <div className={geninfoTab ? "customtab" : "d-none"}>
                  ...
                  <input
                    ...
                    value={
                      applicationDetail?.applicationDate
                        ? moment(applicationDetail?.applicationDate).format(
                            "DD MMM YYYY"
                          )
                        : "N/A"
                    }
            ...
            <div
              className={
                applicationDetail.beneficiaryName ? "inner_form_new " : "d-none"
              }
            >
                  ...
                  <input
                    value={
                      applicationDetail?.usdEquivalent
                        ? applicationDetail?.usdEquivalent.toFixed(2)
                        : "N/A"
                    }
                    disabled
                  />
...
export default FINOtherDepartmentViewDetails;
