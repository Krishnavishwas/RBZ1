...
const CountryMasterTable = () => {
  ...
  const validateForm = () => {
    ...
    if (/[`!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?~]/.test(countryForm.countryCode)) {
      newErrors.countryCode = "special characters not allowed";
      valid = false;
    }
    if (countryForm.countryCode.charAt(0) === " ") {
      newErrors.countryCode = "First character cannot be a blank space";
      valid = false;
    }

    if (/[`!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?~]/.test(countryForm.title)) {
      newErrors.title = "special characters not alloweddd";
      valid = false;
    }
    if (countryForm.title.charAt(0) === " ") {
  ...
  const UpdatevalidateForm = () => {
    ...
    if (updateData.countryName === "") {
      newErrors.countryName = "Title is required";
      valid = false;
    }
    if (/[`!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?~]/.test(updateData.countryCode)) {
      newErrors.countryCode = "special characters not allowed";
      valid = false;
    }
    if (updateData.countryCode.charAt(0) === " ") {
      newErrors.countryCode = "First character cannot be a blank space";
      valid = false;
    }

    if (/[`!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?~]/.test(updateData.countryName)) {
      newErrors.countryName = "special characters not alloweddd";
      valid = false;
    }
    if (updateData.countryName.charAt(0) === " ") {
      ...
      cell: (row) => (
        <>
          ...
          {/* <Link
            to=""
            className=""
            onClick={() => handleDeleteShow(row.id, row.countryName)}
          >
          ...
          subHeaderComponent={
            <div className="admintablesearch">
              ...
              <div className="table-btn-bx">
                ...
                <Button onClick={handleFormShow}>Add Country</Button>
              </div>
            </div>
          }
        />
            ...
            <div className="login_form_panel">
              <Modal.Body className="p-0">
                <div className="form-bx mb-4">
                  ...
                  {errors === true && !countryForm.countryCode ? (
                    <small class="errormsg">Country code is required</small>
                  ) : errors === true &&
                  /[`!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?~]/.test(countryForm.countryCode) ? (
                    <small class="errormsg">
                      special characters not allowed
                    </small>
                  ) : errors === true &&
                    countryForm.countryCode.charAt(0) === " " ? (
                    <small class="errormsg">
...
{/* {errors.countryCode ? (
                ...
                <div className="form-bx mb-4">
                  ...
                  {errors === true && !countryForm.title ? (
                    <small class="errormsg">Title is required</small>
                  ) : errors === true &&
                    /[!@#$%^&*(),.?":{}|<>]/.test(countryForm.title) ? (
                    <small class="errormsg">
                      special characters not allowed
                    </small>
                  ) : errors === true && countryForm.title.charAt(0) === " " ? (
                    <small class="errormsg">
                      First character cannot be a blank space
                    </small>
                  ) : (
        ...
        <div className="application-box editmodal-change">
          <div className="login_inner">
            <div class="login_form ">
              <h5>
                <Modal.Header closeButton className="p-0">
                  <Modal.Title>Update Country Master</Modal.Title>
                </Modal.Header>
              </h5>
            </div>
            <div className="login_form_panel">
                ...
                <div className="form-bx mb-4">
                  ...
                  <label>
                    <input
                      ...
                      name="countryCode"
                      className={
                        errors === true && !updateData.countryCode
                          ? "error"
                          : "fomcontrol"
                      }
                      placeholder="Country Code"
                  ...
                  /[`!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?~]/.test(updateData.countryCode) ? (
                    <small class="errormsg">
                      special characters not allowed
                    </small>
                  ) : errors === true &&
                  updateData.countryCode.charAt(0) === " " ? (
                    <small class="errormsg">
                      First character cannot be a blank space
                    </small>
                  ) : (
                ...
                <div className="form-bx mb-4">
                  ...
                  <label>
                    <input
                      ...
                      name="countryName"
                      className={
                        errors === true && !updateData.countryName
                          ? "error"
                          : "fomcontrol"
                      }
                      placeholder="Title"
                  ...
                  {errors === true && !updateData.countryName ? (
                    ...
                    /[!@#$%^&*(),.?":{}|<>]/.test(updateData.countryName) ? (
                    <small class="errormsg">
                      special characters not allowed
                    </small>
                  ) : errors === true && updateData.countryName.charAt(0) === " " ? (
                    <small class="errormsg">
                      First character cannot be a blank space
                    </small>
                  ) : (
