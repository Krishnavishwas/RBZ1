                        ...
                        .map((items, index) => {
                          return (
                            ...
                            >
                              ...
                              <div className={items?.statusName ? "inner_form_new " : "d-none"}>
                                <label className="controlform">
                              ...
                              <div className={applicationDetail?.analystDescription ? "inner_form_new " : "d-none"}>
                                <label className="controlform">
                                  Analyst Description
                                </label>
                                <div className="form-bx">
                                  
                                  <div dangerouslySetInnerHTML={{ __html: applicationDetail?.analystDescription }} className="analyst_desc" ></div> 
                                 
                                </div>
                              </div>

                              <div className={items?.notes ? "inner_form_new " : "d-none"}>
                                <label className="controlform">Notes</label>
                                <div className="form-bx">
                                  <label>
                                    <textarea
                              ...
                              <div className={items?.comment ? "inner_form_new " : "d-none"}>
                                <label className="controlform">Comments</label>
                                <div className="form-bx">
                                  <label>
                                    <textarea
...
<div className="row">
      ...
      <th scope="col">Turn Around Days</th>
                ...
                {
    tatHistory?.length ? tatHistory?.map((item, index)=>{
      return(
        <>
        <tr>
          <td>{item.roleName}</td>
          <td>{item.name ? item.name : "--"}</td>
          <td>{item.createdDate ?  moment(item.createdDate).format("DD MMM YYYY hh:mm A") : "--"}</td>
          <td>{item.submittedDate ?  moment(item.submittedDate).format("DD MMM YYYY hh:mm A") : "--"}</td>
          <td>{ item.workinG_DAYS}  {item.workinG_DAYS > 1 ? "Days" : "Day" } </td>
        </tr>
        </>
      )
    })
