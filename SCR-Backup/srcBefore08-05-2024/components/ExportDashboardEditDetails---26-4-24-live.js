...
const ExportDashboardEditDetails = ({
  ...
  console.log("setAssignUserID, AssignUserID", AssignUserID);
  const onShow = () => {
    setTimeout(() => {
    ...
    if (validateForm()) {
      ...
      await axios
        .post(APIURL + "ExportApplication/UpdateExportApplications", {
          ...
          ApplicationStatus:  roleID == 5 ?  applicationstaus : (nextlevelvalue == "" && roleID != 5) ? applicationstaus : applicationDetail?.analystRecommendation  ,
          ActionStatus:
            (AssignUserID == "" || AssignUserID == null) &&
            roleID != 5 &&
            roleID != 2 &&
                  ...
                  <div className="form-bx">
                    <label>
                      <textarea
                        ...
                        disabled={roleID == 2 || roleID == 3 || applicationDetail?.roleID == 4 ? false : true}
                      />
                      <span className="sspan"></span>
                    ...
                    <div className="inner_form_new ">
                      ...
                      <div className="form-bx">
                        <Select
                          ...
                          isDisabled={roleID == 2 || roleID == 3 || applicationDetail?.roleID == 4 ? false : true}
                        />
                        ...
                        <div className="form-bx">
                          <label>
                            <input
                              ...
                              disabled={
                                roleID == 2 || roleID == 3 || applicationDetail?.roleID == 4 ? false : true
                              }
                            />
                            <span className="sspan"></span>
                            {errors.relatedexchangeControlNumber ? (
              ...
              return (
                <li className="nav-item" role="presentation">
                  <button
                    ...
                    data-bs-toggle="tab"
                    data-bs-target={"#banksupervisrotab-justified-home" + index}
                    type="button"
                    role="tab"
                    aria-controls="home"
                    aria-selected="true"
                ...
                : `Response ${
                    ...
                    Response {cur?.applicationActivityData?.length - index}
                  </button>
                </li>
              );
            })}
  ...
  <div className="tab-content pt-2">
    <div
      className={
        roleID == 3 ? "tab-pane fade show active" : "tab-pane fade show "
      }
 ...
 <div className="row">
   ...
   <div className="col-md-12  position-relative">
       ...
       {errors.supervisoraction &&
           (nextlevelvalue == "" && supervisordecision == false) ? (
            ...
            return (
              <>
                <div
                  ...
                  id={"banksupervisrotab-justified-home" + index}
                  role="tabpanel"
                ...
                >
                  <div className="bakgroundaction">
                                          ...
                                          <div className={ item?.actionNotes ? "inner_form_new " : "d-none"}>
                                            <label className="controlform">
                                              Action Note
                                            </label>
                                            <div className="form-bx">
                                          ...
                                          <div className={item?.actionComment ? "inner_form_new " : "d-none"}>
                                            <label className="controlform">
                                              Action Comment
                                            </label>
                                            <div className="form-bx">
                                        ...
                                        <div className={item?.description ? "inner_form_new " : "d-none"}>
                                          <label className="controlform">
                                            Recommendation
                                          </label>
                                          <div className="form-bx">
                              ...
                              <div className="hidden-toggles">
                                <input
                                  ...
                                  onClick={() => {
                                    ...
                                    setSupervisorRoleId("");
                                    setAsignUser([]);
                                    setapplicationstaus(applicationDetail?.analystRecommendation)
                                  }}
                                  name="nextaction"
                                  className={applicationDetail?.analystRecommendation == "" || applicationDetail?.analystRecommendation == "0" ? "d-none" :"hidden-toggles__input"}
                                  value="121"
                                  checked={
                                ...
                                <label
                                  ...
                                  className={applicationDetail?.analystRecommendation == "" || applicationDetail?.analystRecommendation == "0" ? "d-none" : "hidden-toggles__label"}
                                >
