...
const AttachmentTable = () => {
  ...
  const application_Data = async () => {
    ...
    try {
      const response = await fetch(
        APIURL + "Master/GetApplicationTypesByDepartmentID",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const subApplication_Data = async () => {
    const application_data = {
      ID: attachmentForm.ApplicationTypeID
        ? attachmentForm.ApplicationTypeID
        : updateData.applicationTypeID,
    };
    ...
    try {
      const response = await fetch(
        APIURL + "Admin/GetSubApplicationTypeByApplicationTypeID",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleSubmit = async (e) => {
    ...
    const application_data = {
      ...
      ApplicationSubTypeID: attachmentForm.ApplicationSubTypeID
        ? attachmentForm.ApplicationSubTypeID
        : "0",
    };
  ...
  const isValid = () => {
    ...
    if (subApplicationData !== null && !attachmentForm.ApplicationSubTypeID) {
      newErrors.ApplicationSubTypeID =
        "Please select application sub category name.";
      valid = false;
    }
            ...
            <>
              <div className="admintablesearch">
                ...
                <div className="table-btn-bx">
                  ...
                  <Button onClick={handleFormShow}>Add Attachment</Button>
                </div>
              </div>
              <div className="application-tab w-100 mt-4">
                <ul class="nav nav-pills mb-3">
                  <li class="nav-item">
                    <a
                      class={tabDepId == 1 ? "nav-link active" : "nav-link"}
                  ...
                  <li class="nav-item">
                    <a
                      class={tabDepId == 2 ? "nav-link active" : "nav-link"}
                  ...
                  <li class="nav-item">
                    <a
                      class={tabDepId == 3 ? "nav-link active" : "nav-link"}
                  ...
                  <li class="nav-item">
                    <a
                      class={tabDepId == 4 ? "nav-link active" : "nav-link"}
            ...
            <div className="login_form_panel">
              <Modal.Body className="p-0">
                ...
                <div className="form-bx mb-4">
                  <label>
                    <select
                      ...
                      value={attachmentForm.ApplicationTypeID}
                    >
                      <option value="" selected>
                        Select Application Category Name
                      </option>
                      {attachmentForm.depID &&
                ...
                <div className="form-bx mb-4">
                  <label>
                    <select
                      name="ApplicationSubTypeID"
                      class=""
                      aria-label="Large select example"
                      onChange={(e) => {
                        changeHandelForm(e);
                      }}
                      value={attachmentForm.ApplicationSubTypeID}
                    >
                      <option value="" selected>
                        Select Application Sub Category Name
                      </option>
                      {attachmentForm.ApplicationTypeID &&
                        subApplicationData &&
                        subApplicationData.length > 0 &&
                ...
                <div className="form-bx mb-4">
                  ...
                  <label>
                    <select
                      ...
                      value={updateData.applicationTypeID}
                    >
                      <option value="" selected>
                        Select Application Category Name
                      </option>
                ...
                <div className="form-bx mb-4">
                  ...
                  <label>
                    <select
                      ...
                      class=""
                      aria-label="Large select example"
                      value={updateData?.applicationSubTypeID}
                      onChange={(e) => {
                        changeUpdateForm(e);
                      }}
                    >
