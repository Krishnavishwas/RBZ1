...
setExpiringDate(applicationDetail?.expiringDate ? applicationDetail?.expiringDate : new Date())
  ...
  return (
    <>
      ...
      {tatHistory?.length && showdataLoader == true ? (
                              ...
                              <div key={firstItem.actionID}>
                                ...
                                <div className="row">
                                  ...
                                  <div className="col-md-3">
                                    <div className="inner_form_new-sm">
                                      <label className="controlform-sm">
                                        {firstItem?.actionStatusName} Date
                                      </label>
                                      <div className="form-bx-sm">
                                        <label>
                                          <input
                      ...
                      >
                        ...
                        <div className="hidden-toggles">
                          <input
                            ...
                            value="1"
                          />
                          <label for={defaultnoExpiry == "1" ? "" : "exprq" } className="hidden-toggles__label">
                            Yes
                          </label>
                          <input
                            type="radio"
                            ...
                            checked={defaultnoExpiry == "0"}
                          />
                          <label for={defaultnoExpiry == "0" ? "" : "noexp"} className="hidden-toggles__label">
                            No
                          </label>
                        </div>
                      </div>
