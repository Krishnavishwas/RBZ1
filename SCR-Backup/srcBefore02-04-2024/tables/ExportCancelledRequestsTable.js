...
const ExportCancelledRequestsTable = () => {
                    ...
                    <table width="100%" className="return-tables">
                      ...
                      <tr>
                        ...
                        >
                          ...
                          applicationDetail?.expiringDate == "" || applicationDetail?.expiringDate == "0001-01-01T00:00:00"
                            ? "N/A"
                            : moment(applicationDetail?.expiringDate).format("DD MMM YYYY")}
                        </td>
                      </tr>
                      <tr>
                        <td
                      ...
                      {applicationDetail?.returnFrequencyName == "Once" ? <tr>
                        <td
                          width="25%"
                          style={{
                            fontSize: "16px",
                        ...
                        >
                          ...
                          applicationDetail?.returnDate == "" || applicationDetail?.returnDate == "0001-01-01T00:00:00"
                            ? "N/A"
                            : moment(applicationDetail?.returnDate).format("DD MMM YYYY")}
                        </td>
                      </tr> : ""}
                    </table>
                  </td>
...
export default ExportCancelledRequestsTable;
