  ...
  const validateForm = () => {
    ...
    if (
      (Description == " " ||
        ...
        Description == "<h2><br></h2>") && applicationDetail?.analystDescription == null &&
      roleID == 5
    ) {
          ...
          <>
            ...
            <div className={banksuperTab ? "customtab" : "d-none"}>
                ...
                return cur?.applicationActivityData.map((item, index) => {
                  if (cur?.assignedToRoleID == 3) {
                    return (
                      <>
                        <div
                          className={item?.notes ? "inner_form_new " : "d-none"}
                        >
                          <label className="controlform">Notes</label>
                          <div className="form-bx">
                            <label>
              ...
              <div className={roleID == 3 ? "inner_form_new " : "d-none"}>
                <label className="controlform">Submit To Record Officer</label>
                    ...
                    <div className="col-md-12">
                      {checkSupervisor == true && roleID == 5 ? (
                        <>
                          <div className="inner_form_new">
                            <label className="controlform">
                             {nextlevelvalue == "20" ? "User" : "Submit To Senior Analyst"}
                            </label>
                            ...
                            <div className="form-bx">
                              <label>
                                ...
                                >
                                  <option value="">
                                    {nextlevelvalue == "20" ? "Select User": "Select Senior Analyst"}
                                  </option>
                                  ...
                                  <td className="p-0" colSpan="2">
                                    ...
                                    >
                                      ...
                                      <tr>
                                        ...
                                        >
                                          : <span style={{minWidth:"45px",display:"inline-block",paddingRight:"5px"}}>{applicationDetail?.currencyCode}</span>
                                      ...
                                      <tr>
                                        ...
                                        >
                                          : <span style={{minWidth:"45px",display:"inline-block",paddingRight:"5px"}}>USD</span>
                                          {applicationDetail?.usdEquivalent}
                                        </td>
                                      </tr>
                                      <tr>
                      ...
                      <div class="login_form ">
                        <h5>
                          <Modal.Header closeButton className="p-0">
                            <Modal.Title>Pdf <span style={{textTransform:"capitalize"}}>Preview</span> --{" "}
                              <big>
                                {applicationDetail?.rbzReferenceNumber
                                  ? applicationDetail?.rbzReferenceNumber
                                  : ""}
                                  ...
                                  >
                                    <tr>
                                      ...
                                      >
                                        ...
                                        >
                                          RE: {applicationDetail?.applicationType ? applicationDetail?.applicationType : "N/A"}
                                        </p>
                                      </td>
                                    </tr>
                                    <tr>
                                  ...
                                  <table>
                                    ...
                                    <tr>
                                      ...
                                      >
                                        ...
                                        >
                                          {PdfUsername ? PdfUsername.replace(/"/g, "") : "N/A"}
                                        </p>
                                        <h3
                                          style={{
                                            color: "#000",
            ...
            <button
              ...
              disabled={
                (applicationstaus == 3 ||
                  ...
                  Description == "" ||
                  Description == null ||
                  !Description  ) && applicationDetail?.analystDescription == null && 
                roleID == 5
                  ? true
                  : false
              }
