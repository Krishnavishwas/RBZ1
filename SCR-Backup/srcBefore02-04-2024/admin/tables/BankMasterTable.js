...
const BankMasterTable = () => {
    ...
    console.log("banknameEditpdfF--banknameEditpdfF", banknameEditpdfF)
                ...
                if (item.id == pdfID) {
                    return (
                        <div style={{ opacity: 0, height: 0 }} className="editorpdf-data">
                            <div ref={targetRef} >
                                {/* <img src="https://dmsupgrade.in/Images/images/abc.png"/> */}
                            {/* <img src="https://letsenhance.io/static/8f5e523ee6b2479e26ecc91b9c25261e/1015f/MainAfter.jpg" alt="Girl in a jacket" width="500" height="600"/> */}
