...
applicationDetail?.attachedFiles?.forEach(item => labelSet.add(item.label));
...
const finalArray = Array.from(labelSet)?.map(label => {
    const attachedFile = applicationDetail?.attachedFiles?.find(item => item.label === label);
...
{files?.map((items, index) => {
                          return (
                            ...
                            >
                              ...
                              <span className="filename">
                              {files?.map((f, i) => (
    i === index ? (f?.fileName || "No file chosen") : ""
))}

                              </span>
                              {files?.length &&
                              files?.find((f, i) => i == index)
                                ?.f?.fileName ? (
                                <button
                                  type="button"
