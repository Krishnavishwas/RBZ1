...
const ExportNewRequestForm = () => {
  ...
  const slicedData = ValidateRBZ.slice(first, first + rows);
  // ------ pagination end
    ...
    <>
      <form>
                            ...
                            ValidateRBZ.length > 0 ?
                              <>
                                <Accordion >
                                  {
                                    slicedData?.map((item) => {
                                      ...
                                      return (
                                        <AccordionTab header={item.rbzReferenceNumber}>
                                          <p className="m-0">
                                            <div className="table-responsive validatepecanTable">
                                            <table>
                                              <thead>
                                                <tr>
                                                  {/* <th>RBZ Reference Number</th> */}
                                              ...
                                              <tbody>
                                                ...
                                                {
                                              bankName.replace(/"/g, "") == item?.bankName ?
                                                <tr>

                                                  <td colSpan='6'>
                                                    <p className="validateRBZFieldBottom">
                                                    <i
                                                      className="pi pi-eye"
                                                      style={{ padding: "12px", cursor: "pointer" }}
                                                      onClick={() => {
                                                        handleViewData(item.id);
                                                        GetHandelDetail(item?.rbzReferenceNumber, item.id);
                                                      }}
                                                      onMouseEnter={(e) => {
                                            ...
                                            {/* <>
                                            <p className="validateRBZField">
                                              <span className="head">RBZ Reference Number</span>
                                              <span>{item?.rbzReferenceNumber}</span>
                                            </p>
                                            <p className="validateRBZField">
                                              <span className="head">Application Type</span>
                                            ...
                                            <p className="validateRBZField">
                                              <span className="head">Bank Name</span>
                                              <span>{item?.bankName}</span>
                                            </p>
                                            <p className="validateRBZField">
                                              <span className="head">Applicant Name</span>
                                              <span>{item?.name ? item?.name : "N/A"}</span>
                                            </p>
                                            <p className="validateRBZField">
                                              <span className="head">Submitted Date</span>
                                ...
                                <div className="d-flex align-items-center justify-content-between p-2">
                                  <Paginator first={first} rows={rows} totalRecords={ValidateRBZ?.length} rowsPerPageOptions={[5, 50, 100]} onPageChange={onPageChange} />

                                  <button className="validateCrossIcon" onClick={() => setValidateShow(false)}><i className="bi bi-x-circle"></i></button>
                                </div>
                              </>
                              : <div className="d-flex align-items-center justify-content-between p-2">
        ...
        <div className="form-footer mt-5 mb-3">
          ...
          >
           {submitbuttonhide == true ? <>Submit<div className="smallloader"></div></> : "Submit"} 
          </button>
        </div>
        {updatepopup == true ? (
          <UpdatePopupMessage
