          ...
          <ul className="d-flex align-items-center">
            ...
            <li className="nav-item  ">
              <Link className="nav-link nav-icon">
                {" "}
                <span>Welcome {Name?.replace(/"/g, "")}</span>
              </Link>
            </li>
        ...
        <div className="application-box">
          ...
          {actinglist?.length
            ...
            : ""}
                        ...
                        <div className="action_form_new">
                          <label className="actioncontrolform">Reason</label>
      ...
      return(
        <tr>
          ...
          <td><button className={item.statusName == "Active" ? "activebtn-text" : "inactivebtn-text"} onClick={(e)=> handleChangeActionStatuschange(item.id, item.status)}>
           {
           item.statusName == "Active" ? <i className="bi bi-toggle2-on"></i> :  <i className="bi bi-toggle2-off"></i>
           }
