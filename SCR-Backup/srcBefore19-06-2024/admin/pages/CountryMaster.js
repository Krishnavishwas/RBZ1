...
import CountryMasterTable from '../tables/CountryMasterTable'

const CountryMaster = () => {
    return (
        <>
            <Helmet><title>Country</title></Helmet>
                    ...
                    <div className='row'>
                        <div className='col-md-12'>
                            <div className='datatable'>
                                <h4 className='section_top_heading'>Country</h4>

                                {/* CountryMaster tableData */}
                                <CountryMasterTable />
                            </div>
                        </div>
                    </div>
