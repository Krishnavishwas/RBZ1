  ...
  return (
    <>
      <form>
        ...
        <div className="inner_form_new ">
          ...
          <div className="form-bx">
            ...
            <DatePicker
              ...
              selected={startDate} 
              placeholderText={startDate == null ? moment(new Date()).format("DD/MM/YYYY") : startDate} 
        ...
        <div className="inner_form_new ">
          <label className="controlform">Submit to {roleID == 2 ? "Bank Supervisor" : "Analyst"}</label>
