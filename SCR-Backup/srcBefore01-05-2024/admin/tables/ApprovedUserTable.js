...
const ApprovedUserTable = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            cell: (row) => (
                <>
                    <Link to="" className="me-2" onClick={() => handleUpdate(row.userID)}>
                        ...
                        <div class="login_form ">
                            <h5>
                                <Modal.Header closeButton className="p-0">
                                    <Modal.Title>Approved User</Modal.Title>
                                </Modal.Header>
                            </h5>
                        </div>
                        <div className="login_form_panel">
                            <Modal.Body className="p-0">
                                ...
                                <div className="form-bx mb-4">
                                    ...
                                    {updateerr?.emailID ? (
                                        <span className="errormsg">{updateerr?.emailID}</span>
                                    ) : (
                                        ""
                                    )}
                                </div>
                                <div className="form-bx mb-4">
                                    ...
                                    {updateerr?.address ? (
                                        <span className="errormsg">{updateerr?.address}</span>
                                    ) : (
                                        ""
                                    )}
                                </div>
                                <div className="form-bx mb-4">
                                    ...
                                    {updateerr?.phoneNumber ? (
                                        <span className="errormsg">{updateerr?.phoneNumber}</span>
                                    ) : (
                                        ""
                                    )}
                                </div>
                                ...
                                <div className="form-bx mb-4">
                                    ...
                                    <label>
                                        <select
                                            name="applyingFor"
                                            onChange={(e) => { changeUpdateForm(e) }} value={updateData?.applyingFor}
                                        >
                                            <option value="" disabled>Select Applying For</option>
                                    ...
                                    {updateerr?.applyingFor ? (
                                        <span className="errormsg">{updateerr?.applyingFor}</span>
                                    ) : (
                                        ""
                                    )}
                                </div>
                                            ...
                                            return (
                                                <div className="deptInner-box d-flex mb-2" key={index}>
                                                    <input
                                                        ...
                                                        onChange={() => changeDptFrom(item.id)}
                                                    />
