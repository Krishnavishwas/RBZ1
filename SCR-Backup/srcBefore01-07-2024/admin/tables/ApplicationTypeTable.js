                        ...
                        <div className="login_form_panel">
                            <Modal.Body className="p-0">
                                <div className="form-bx mb-4">
                                    <label>
                                        <input type="text" name="name" className='fomcontrol text-capitalize' value={applicationTypeForm?.name} placeholder="Application Category Name" onChange={(e) => { changeHandelForm(e) }} onKeyDown={(e) => {
                                            if (e.key === "_") {
                                                e.preventDefault();
                                            }
                                        }} required />
                            ...
                            <Modal.Body className="p-0">
                                ...
                                <div className="form-bx mb-4">
                                    ...
                                    <label>
                                        ...
                                        <select name="departmentID" className="" aria-label="Large select example" onChange={(e) => { changeUpdateForm(e) }} required value={updateData.departmentID} >
                                            <option value="" selected>Select Department</option>
                                            {
                                                departmentData.map((item) => {
                                                    return (
