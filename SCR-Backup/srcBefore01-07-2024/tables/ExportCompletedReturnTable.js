...
const ExportCompletedReturnTable = () => {
  ...
  const [exportsCompletedReturnsData, setExportsCompletedReturnsData] = useState([]);
...
//         if (res.data.responseCode === "200") {
//           setPageLoader(false);
//           setExportsCompletedReturnsData(res.data.responseData);
...
const handleData = async () => {
  ...
  const filteredData = exportsCompletedReturnsData?.filter(
    (item) =>
  ...
  useEffect(() => {
    handleData();
    handleTabCount();
    setExportsCompletedReturnsData([]);
  }, [tabDepId]);
  console.log("exportsCompletedReturnsData", exportsCompletedReturnsData);
  return (
    <>
      {/* {tabHeader} */}
      {pageLoader == true ? (
      ...
      ) : exportsCompletedReturnsData?.length === 0 ? (
        ...
        <>
          ...
          <div>
            ...
            <DataTable
              ...
              value={exportsCompletedReturnsData}
              scrollable
              scrollHeight="600px"
              // className="mt-4"
              // paginator={exportsCompletedReturnsData.length > 10 ? true : false}
              filters={filters}
