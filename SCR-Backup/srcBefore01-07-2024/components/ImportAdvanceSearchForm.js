...
import ImportAdvanceSearchTable from '../tables/ImportAdvanceSearchTable'
...
const ImportAdvanceSearchForm = () => {
    ...
    const HandleSubmit = async (e) => {
        ...
        if (validateForm()) {
            ...
            await axios    
                .post(APIURL + "ReportData/GetImportReportDataView", {
                    // UserID: UserID.replace(/"/g, ""),
    ...
    return (
        <>
            <form className="bankReportForm">
                ...
                <ImportAdvanceSearchTable advanceSearchData={advanceSearchData} />
                {/* table data show end */}
                {/* {updatepopup == true ? (
                    <UpdatePopupMessage
                        heading={heading}
...
export default ImportAdvanceSearchForm;
