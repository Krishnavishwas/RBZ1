...
import FINAdvanceSearchTable from "../tables/FINAdvanceSearchTable";
...
const FINAdvanceSearchForm = () => {
    ...
    const HandleSubmit = async (e) => {
        ...
        if (validateForm()) {
            ...
            await axios    
                .post(APIURL + "ReportData/GetFINReportDataView", {
                    // UserID: UserID.replace(/"/g, ""),
    ...
    return (
        <>
            <form className="bankReportForm">
                ...
                <FINAdvanceSearchTable advanceSearchData={advanceSearchData} />
                {/* table data show end */}
                {/* {updatepopup == true ? (
                    <UpdatePopupMessage
                        heading={heading}
...
export default FINAdvanceSearchForm;
