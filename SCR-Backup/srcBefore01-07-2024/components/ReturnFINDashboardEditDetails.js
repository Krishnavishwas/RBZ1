...
const ReturnFINDashboardEditDetails = ({
  applicationDetail,
...
console.log("errors -", errors);
  ...
  const validateForm = () => {
    ...
    if(Description == "" || Description == "<p></p>" && roleID >= 5){
                      ...
                      {countries?.map((item, ind) => {
                        return (
                          <option
                            ...
                            value={item.id}
                            selected={
                              applicationDetail?.countryName == item.countryName
                            }
                          >
                            {item.countryName}
                          </option>
            ...
            {applicationDetail?.roleID !== 4 ? (
              <>
                ...
                >
                  ...
                  <span
                    className="btn-collapse cursorpointer"
                  ...
                  <div className="tab-content pt-2">
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="row">
                          <div className="col-md-12">
                            <div className="hidden-toggles" style={{ overflow: "visible" }}>
                              <input
                                type="radio"
                          ...
                          <div className="col-md-12 my-2">
                            ...
                            <input
                              ...
                              (applicationstaus == "" ||
                                ...
                                applicationstaus == "0") &&
                              nextlevelvalue == "" ? (
                                <small className="errormsg" style={{marginBottom:"9px"}}>
                                  {errors.decision}
                                </small>
                              ) : (
                                ""
                        ...
                        <table width="100%">
                          ...
                          >
                            ...
                            >
                              :{" "}
                              {ExpiringDate
                                ? moment(ExpiringDate).format("DD MMMM YYYY")
                                : applicationDetail?.expiringDate == null ||
                                  applicationDetail?.expiringDate == "" ||
                                  applicationDetail?.expiringDate ==
                                    "0001-01-01T00:00:00"
                          ...
                          {getFrequencyID == "1" ? (
                            <tr>
                              ...
                              >
                                :{" "}
                                {IsReturnExpiringDate
                                  ? moment(IsReturnExpiringDate).format(
                                      "DD MMMM  YYYY"
                                    )
                                  : applicationDetail?.returnDate == null ||
                                    applicationDetail?.returnDate == "" ||
...
export default ReturnFINDashboardEditDetails;
