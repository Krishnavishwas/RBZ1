...
const INSOtherDepartmentEditDetails = ({
  ...
  const HandleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      await axios
        .post(APIURL + "ReferredApplication/UpdateReferredApplication", {
          ID: applicationDetail?.id,
          AssignedTo:
          ...
          StationeryData:
            applicationDetail?.applicationTypeID == "53" ? StationeryData : [],
          PersonnelData:
          ...
          Structure_OrganogramData:
            applicationDetail?.applicationTypeID == "53" ? OrganogramData : [],
          Anti_Money_laundering_CombatingData:
            applicationDetail?.applicationTypeID == "53" ? AntiMoneData : [],
          ApplicationSubTypeID:
            applicationDetail?.applicationTypeID == "54" ? exactReturnType : "",
                            ...
                            <div className="row">
                              <div className="col-md-12">
                                <div className="hidden-toggles">
                                  ...
                                  />
                                  <label
                                    for="DDcoloration-Approvedved4"
                                    className="hidden-toggles__label"
                                  >
                                    Referred to Original Department
                                  </label>
                                </div>
                              </div>
                            </div>
