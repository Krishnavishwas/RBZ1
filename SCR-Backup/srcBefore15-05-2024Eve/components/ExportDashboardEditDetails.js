              ...
              {applicationDetail?.roleID !== 4 ? (
                <>
                  ...
                  >
                    ...
                    <span className="btn-collapse cursorpointer"  onClick={() => setbanksuperTab(!banksuperTab)}>
                      <i className="bi bi-caret-down-fill"></i>
                    </span>
              ...
              {roleID >= 4 && applicationDetail?.roleID !== 4 ? (
                <>
                  ...
                  >
                    ...
                    <span className="btn-collapse cursorpointer" onClick={() => setrecordTab(!recordTab)}>
                      <i className="bi bi-caret-down-fill"></i>
                    </span>
                    {applicationDetail?.parentApplicationID !== 0 &&
                  roleID == 4 ? (
              ...
              {roleID >= 4 ? (
                <>
                  ...
                  >
                    ...
                    <span className="btn-collapse cursorpointer " onClick={() => setanalystTab(!analystTab)}>
                      <i className="bi bi-caret-down-fill"></i>
                    </span>
                    {applicationDetail?.parentApplicationID !== 0 &&
                  roleID == 5 ? (
                        ...
                        <div className="inner_form_new align-items-center">
                          ...
                          <div className=" cccto">
                            <div className="flex justify-content-center multiSelect">
                              ...
                              <MultiSelectComponent selectedBanks={selectedBanks} setSelectedBanks={setSelectedBanks} vOption={vOption} />
              ...
              {roleID >= 4 ? (
                <>
                  ...
                  >
                    ...
                    <span className="btn-collapse cursorpointer"  onClick={() => setsranalystTab(!sranalystTab)}>
                      <i className="bi bi-caret-down-fill"></i>
                    </span>
                    {applicationDetail?.parentApplicationID !== 0 &&
                  roleID == 6 ? (
              ...
              {roleID >= 4 ? (
                <>
                  ...
                  >
                    ...
                    <span className="btn-collapse cursorpointer"  onClick={() => setprincipalanalystTab(!principalanalystTab)}>
                      <i className="bi bi-caret-down-fill"></i>
                    </span>
                    {applicationDetail?.parentApplicationID !== 0 &&
                  roleID == 7 ? (
              ...
              {roleID >= 4 ? (
                <>
                  ...
                  >
                    ...
                    <span className="btn-collapse cursorpointer" onClick={() => setdeputyTab(!deputyTab)}>
                      <i className="bi bi-caret-down-fill"></i>
                    </span>
                    {applicationDetail?.parentApplicationID !== 0 &&
                  roleID == 8 ? (
              ...
              {roleID >= 4 ? (
                <>
                  ...
                  >
                    ...
                    <span className="btn-collapse cursorpointer" onClick={() => setdirector(!director)}>
                      <i className="bi bi-caret-down-fill"></i>
                    </span>
                    {applicationDetail?.parentApplicationID !== 0 &&
                  roleID == 9 ? (
