                    ...
                    <div className="login_inner">
                        ...
                        <div className="login_form_panel">
                            <Modal.Body className="p-0">
                                ...
                                <div className="form-bx mb-4">
                                    <label>
                                        <select name="ApplicationTypeID" value={applicationSubTypeForm.ApplicationTypeID} className="" aria-label="Large select example" onChange={(e) => { changeHandelForm(e) }}>
                        ...
                        <div className="login_form_panel">
                            <Modal.Body className="p-0">
                                ...
                                <div className="form-bx mb-4">
                                    ...
                                    <label>
                                        <select name="departmentID" className="" aria-label="Large select example" onChange={(e) => { changeUpdateForm(e) }} value={updateData?.departmentID} disabled>
                                            <option value="" selected>Select Department</option>
                                            {
                                                departmentData?.map((item) => {
                                                    return (
                                ...
                                <div className="form-bx mb-4">
                                    ...
                                    <label>
                                        <select name="applicationTypeID" className="" aria-label="Large select example" onChange={(e) => { changeUpdateForm(e) }} value={updateData?.applicationTypeID} disabled>
                                            <option value="" selected>Select Application Category Name</option>
