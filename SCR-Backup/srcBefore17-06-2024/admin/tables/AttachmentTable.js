    ...
    const columns = [
        ...
        },
        {
            ...
            cell: row => <> <Link to="" className="me-2"
                onClick={() => handleUpdate(row.id, row.name)}><i className="bi bi-pencil-square"></i></Link>
                            ...
                            <div className="application-tab w-100 mt-4">
                                <ul className="nav nav-pills mb-3">
                                    <li className="nav-item">
                                        <a className={tabDepId == 1 ? "nav-link active" : "nav-link"} onClick={(e) => handleClickTag(1)}>Exports</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className={tabDepId == 2 ? "nav-link active" : "nav-link"} onClick={(e) => handleClickTag(2)}>Imports</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className={tabDepId == 3 ? "nav-link active" : "nav-link"} onClick={(e) => handleClickTag(3)}>Foreign Investments</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className={tabDepId == 4 ? "nav-link active" : "nav-link"} onClick={(e) => handleClickTag(4)}>Inspectorate</a>
                                    </li>
                                </ul>
                    ...
                    <div className="login_inner">
                        ...
                        <div className="login_form_panel">
                            <Modal.Body className="p-0">
                                ...
                                <div className="form-bx mb-4">
                                    <label>
                                        <select name="depID" className="" aria-label="Large select example" onChange={(e) => { changeHandelForm(e) }}>
                                ...
                                <div className="form-bx mb-4">
                                    <label>
                                        <select name="ApplicationTypeID" className="" aria-label="Large select example" onChange={(e) => { changeHandelForm(e) }} value={attachmentForm.ApplicationTypeID}>
                                ...
                                <div className="form-bx mb-4">
                                    <label>
                                        <select name="ApplicationSubTypeID" className="" aria-label="Large select example" onChange={(e) => { changeHandelForm(e) }} value={attachmentForm.ApplicationSubTypeID}>
                        ...
                        <div className="login_form_panel">
                            <Modal.Body className="p-0">
                                ...
                                <div className="form-bx mb-4">
                                    ...
                                    <label>
                                        <select name="departmentID" disabled className="" aria-label="Large select example" onChange={(e) => { changeUpdateForm(e) }} value={updateData?.departmentID}>
                                            <option value="" selected>Select Department</option>
                                            {
                                                departmentData?.map((item) => {
                                                    return (
                                ...
                                <div className="form-bx mb-4">
                                    ...
                                    <label>
                                        <select name="applicationTypeID" disabled className="" aria-label="Large select example" onChange={(e) => { changeUpdateForm(e) }} value={updateData.applicationTypeID}>
                                            <option value="" selected>Select Application Category Name</option>
                                ...
                                <div className="form-bx mb-4">
                                    ...
                                    <label>
                                        <select name="applicationSubTypeID" disabled className="" aria-label="Large select example" value={updateData?.applicationSubTypeID} onChange={(e) => { changeUpdateForm(e) }} >
                                            <option value="" selected>Select Application Sub Category Name</option>
