                ...
                doc
                  .html(PdftargetRef.current, {
                    ...
                    async callback(doc) {
                      ...
                      formData.append("CircularReferenceNumber", applicationDetail.circularReferenceNumber);
                      formData.append("DepartmentID", applicationDetail.departmentID)
                    ...
                    <div className="tab-content pt-2">
                      ...
                      {/* {noDataComment?.map((v, i) => {
                        if (v.roleID == 8 && v.isDataAvailable == 0) {
                          return (
                            <div className={deputyTab ? "customtab" : "d-none"} key={v.roleID}>
                              <div class="text-center">No Data Found</div>
                            </div>
                          );
                        }
                ...
                <>
                  ...
                  <div className={director ? "customtab mb-3" : "d-none"}>
                    ...
                    <div className="tab-content pt-2 mb-2">
                      ...
                      {/* {noDataComment?.map((data, i) => {
                        if (data.roleID == 9 && data.isDataAvailable == 0 && i == 8) {
                          return (
                            <div
                ...
                <div>
                  ...
                  <button
                    ...
                    disabled={nextlevelvalue == "" &&
                      ...
                      (SubmitBtnLoader == true) || (nextlevelvalue == "" && checkSupervisor == false && ((applicationstaus == "0" || applicationstaus == undefined) && roleID == 9))
                      // ||
                  ...
                  >
                    <table width="100%">
                      ...
                      <tr>
                        ...
                        >
                          {moment(
                            releasingDate ? releasingDate : applicationDetail.releasingDate
                          ).format("DD MMMM YYYY")}
                        </td>
                      </tr>
                      <tr>
                                                ...
                                                return (
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td>
                                                      ...
                                                      {item?.filePath?.map((fileitem) => {
                                                        if (item.value == fileitem.directiveID) {
                                                          return (
                                                            <span
                                                              style={{
                                                                marginBottom: "3px",
                              ...
                              <td>
                                <div>
                                  {applicationDetail?.bankData?.length > 0 ? (
                                    <>
                                      :{" "}
                                      {(applicationDetail?.bankData || selectedBanks).map((item) => {
                                        return (
