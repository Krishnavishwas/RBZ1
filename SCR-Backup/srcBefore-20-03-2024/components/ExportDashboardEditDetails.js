...
const getTargetElement = () => document.getElementById('DescriptionPDFDownload');

const downloadPDFBUTTON = () => {
    generatePDF(getTargetElement, option)
}
                          ...
                          <>
                            ...
                            >
                              ...
                              {index == 0 ? (
                                ...
                                <button type="button" onClick={() => generatePDF(targetRef, {filename: 'page.pdf', option})} >Download</button>
                                <div style={{opacity:"0", height:"0px"}}>
                                <div ref={targetRef} className="p-5 mx-auto">
                                <div dangerouslySetInnerHTML={{__html:  Description ? Description : applicationDetail?.analystDescription}} />
                                </div>
                                </div>
                                </>
                              ) : (
                      ...
                      <div className="col-md-12 my-2">
                        <div className="hidden-toggles">
                          <input
                            ...
                            onClick={() => {setRecomdAnalyst("121"); setnextlevelvalue("")}}
                            name="nextaction"
                            className="hidden-toggles__input"
                            value="121"
