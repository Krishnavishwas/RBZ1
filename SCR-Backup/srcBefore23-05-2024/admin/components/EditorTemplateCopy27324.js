...
console.log("headerFileUrl333",headerFileUrl);
    const handleFooterimg = (e) => {
        const file = e.target.files[0];
        setFooterFileUrl(file)
        if (file) {
    ...
    const handleSubmitHtml = async (e) => {
        ...
        const formData = new FormData();
        formData.append('files', headerFileUrl);
        formData.append('files', footerFileUrl);
        ...
        try {
            //  Upload files
            // const uploadResponse = await fetch(ImageAPI + 'File/UploadFile', {
            //     method: "POST",
            //     body: formData
            // });
                    ...
                    <div className="row">
                        <div className="cont-md-12">
                            <div className="card p-4 editor-box">
                                <div class="back-btn" onClick={() => setShowBankMasterTable(true)}><i class="bi bi-arrow-left"></i></div>
                                <div className="row">
