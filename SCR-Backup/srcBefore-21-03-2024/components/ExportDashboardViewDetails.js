...
const ExportDashboardViewDetails = ({
        ...
        {applicationDetail?.applicationType && (
          <div className="inner_form_new ">
            ...
            <div className="form-bx">
              <label>
                <select disabled>
                  <option value="" selected>{applicationDetail.applicationType}</option>
                </select>
                <span className="sspan"></span>
              </label>
            </div>
        ...
        {applicationDetail?.sectorName ? (
          <div className="inner_form_new ">
            ...
            <div className="form-bx">
              <label>
                <select disabled>
                  <option value="" selected>{applicationDetail?.sectorName}</option>
                </select>
                <span className="sspan"></span>
              </label>
            </div>
  ...
  roleID > 3 ?
  <>
<h5 className={banksuperTab ?"section_top_subheading mt-3 py-3 btn-collapse_active cursorpointer" : "section_top_subheading mt-3 py-3 cursorpointer"} onClick={()=>setbanksuperTab(!banksuperTab)}>Bank Supervisor <span className="btn-collapse" ><i class="bi bi-caret-down-fill"></i></span></h5>
        ...
        if(cur?.assignedToRoleID == 3){
          return(
            ...
            <div className="inner_form_new ">
              ...
              <div className="form-bx">
              <label><textarea name="Notes" placeholder="Notes" class="" value={item?.notes} disabled></textarea></label>
              </div>
            </div>
            <div className="inner_form_new ">
              <label className="controlform">Comments</label>
              <div className="form-bx">
              <label><textarea name="Notes" placeholder="Notes" class="" value={item?.comment} disabled></textarea></label>
              </div>
            </div>
            </>
          )
...
<h5 className={recordTab ?"section_top_subheading mt-3 py-3 btn-collapse_active cursorpointer" : "section_top_subheading mt-3 py-3 cursorpointer"}  onClick={()=>setrecordTab(!recordTab)}>Record Officer <span className="btn-collapse"><i class="bi bi-caret-down-fill"></i></span></h5>
              ...
              {roleID > 5 || cur.assignedToRoleID == roleID ? (
                <>
                  ...
                  <div className={analystTab ? "customtab" : "d-none"}>
                    <ul className={ cur.applicationActivityData.length > 1 ? "nav nav-pills mb-3" : "d-none"} role="tablist">
                      {cur?.applicationActivityData.map((items, index) => {
                        return (
                          <li className="nav-item" role="presentation">
                            ...
                            > 
                              {index == 0 ? "Recent" : `Response ${cur?.applicationActivityData.length - index}`} {" "}
...
<div className="inner_form_new ">
                                <label className="controlform">Analyst Recommendation</label>
                                <div className="form-bx">
                                  <label>
                                    <input
                                      name="Notes"
                        ...
                        return (
                          <li className="nav-item" role="presentation">
                            <button
                              ...
                              id={"analyst" + index}
                              data-bs-toggle="tab"
                              data-bs-target={"#sranalyst-justified-home" + index}
                              type="button"
                              role="tab"
                              aria-controls="home"
                              aria-selected="true"
                      ...
                      {cur?.applicationActivityData
                        ...
                        .map((items, index) => {
                          return (
                            ...
                            >
                              <div className="inner_form_new ">
                                <label className="controlform">Senior Analyst Recommendation</label>
                                <div className="form-bx">
                                  <label>
                                    <input
                                      name="Notes" 
                                      className=""
                                      value={items?.statusName ? items?.statusName : ""}
                                      disabled
                                      />
                        ...
                        return (
                          <li className="nav-item" role="presentation">
                            <button
                              ...
                              id={"analyst" + index}
                              data-bs-toggle="tab"
                              data-bs-target={"#pranalyst-justified-home" + index}
                              type="button"
                              role="tab"
                              aria-controls="home"
                              aria-selected="true"
                      ...
                      {cur?.applicationActivityData
                        ...
                        .map((items, index) => {
                          return (
                            ...
                            >
                               <div className="inner_form_new ">
                                <label className="controlform">Principal Analyst Recommendation</label>
                                <div className="form-bx">
                                  <label>
                                    <input
                                      name="Notes"
            ...
            <>
              {roleID > 8 || cur.assignedToRoleID == roleID ? (
                <>
                  ...
                  <ul className={ cur.applicationActivityData.length > 2 ? "nav nav-pills mb-3" : "d-none"} role="tablist">
                      {cur?.applicationActivityData.map((items, index) => {
                        return (
                          <li className="nav-item" role="presentation">
                            <button
                      ...
                      {cur?.applicationActivityData
                        ...
                        .map((items, index) => {
                          return (
                            ...
                            >
                              <div className="inner_form_new ">
                                <label className="controlform">Deputy Director Recommendation</label>
                                <div className="form-bx">
                                  <label>
                                    <input
                                      name="Notes"
...

{
  roleID > 9 ?
  <>
<h5 className={director ?"section_top_subheading mt-3 py-3 btn-collapse_active cursorpointer" : "section_top_subheading mt-3 py-3 cursorpointer"} onClick={()=>setdirector(!director)}>Director <span className="btn-collapse" ><i class="bi bi-caret-down-fill"></i></span></h5>
      ...
      cur?.applicationActivityData.map((item, index)=>{
        if(cur?.assignedToRoleID == 9){
          return(
            <>
             <div className="inner_form_new ">
                                <label className="controlform">Director Recommendation</label>
                                <div className="form-bx">
                                  <label>
                                    <input
                                      name="Notes"
