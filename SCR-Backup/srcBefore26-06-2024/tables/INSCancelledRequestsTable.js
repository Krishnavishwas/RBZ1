...
const INSCancelledRequestsTable = () => {
  ...
  // ----- Start Code For Geting Table List Data InspectorateApplication/GetINSDataByUserID
...
export default INSCancelledRequestsTable;
