...
const DeptID = menuname === "Exports" ? "2" : menuname === "Imports" ? "3": menuname === "Foreign Investments" ? "4" : menuname === "Inspectorate" ? "5" : ImporttabDepId
      ...
      await axios
        ...
        .then((res) => {
          if (res.data.responseCode === "200") {
            ...
            shareformData.append("DepartmentID", "3");
