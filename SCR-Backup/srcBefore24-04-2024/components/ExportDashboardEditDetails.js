...
const ExportDashboardEditDetails = ({
  ...
  const validateForm = () => {
    ...
    if (checkSupervisor == false && (applicationstaus == "" || applicationstaus == "0") && roleID == 3 && nextlevelvalue != 20) {
    ...
    if (checkSupervisor == false && Description == "" && roleID == 3 && nextlevelvalue != 20) {
      newErrors.Description = "Description is required";
      valid = false;
    }
    if (checkSupervisor == false && roleID == 3 && AssignUserID == "" && nextlevelvalue == 20) {
    ...
    if (validateForm()) {
      ...
      await axios
        .post(APIURL + "ExportApplication/UpdateExportApplications", {
          ...
          CompanyID:
            (applicationDetail?.applicantType == "1" || applicationDetail?.userTypeID == "1") && applicationDetail?.bankID !== "" ? getCompanyName ? getCompanyName.value : applicationDetail?.companyID : "",
        ...
        .then( (res) => {
          console.log("res--UpdateExportApplications", res)
          if (res.data.responseCode === "200") {
            ...
            // setupdatepopup(true);
            if ((AssignUserID == "" || AssignUserID == null) && roleID != 5 && roleID != 2 && roleID != 4) {
                 ...
                 axios
                  ...
                  .then( (response) => {
                    if (response.data.responseCode === "200") {
                      if (response.data.responseData?.headerFooterData['0']?.fileType == 'HeaderFile') {
                        var headerImage = response.data.responseData.headerFooterData['0'].filePath;
                        var headerImagewidth = response.data.responseData.headerFooterData['0'].imageWidth;
                      } else {
                        var headerImage = '';
                      }
                      if (response.data.responseData?.headerFooterData['1']?.fileType == 'FooterFile') {
                        var footerImage = response.data.responseData.headerFooterData['1'].filePath;
                        var footerImagewidth = response.data.responseData.headerFooterData['1'].imageWidth;
                      } else {
                        var footerImage = '';
                      }
                        ...
                        if (roleID != 3) {
                          ...
                          if (footerImage != '') {
                            ...
                            if (pagewidth > footerImagewidth) {
                              var diff = parseInt(pagewidth) - parseInt(footerImagewidth);
                            ...
                            for (var i = 1; i <= pageCount; i++) {
                              doc.setPage(i)
                              doc.addImage(footerImage, 'png', positionLeftFooter, footerpositionfromTop, 150, 80, 'Footer', 'NONE', 0)
                            }
                          }
                      ...
                      const addHeader = doc => {
                        if (roleID != 3) {
                          ...
                          if (headerImage != '') {
                            ...
                            for (var i = 1; i <= pageCount; i++) {
                              doc.setPage(i)
                              doc.addImage(headerImage, 'png', positionLeft, 10, 80, 80, 'Header', 'NONE', 0)
                            }
                          } else {
                  ...
                  await axios
                    ...
                    .then(async (response) => {
                      ...
                      if (response.data.responseCode === "200") {
                        ...
                        let docWidth = doc.internal.pageSize.getWidth();
                        await doc.html(CoverigLetterRef.current, {
                          width: 513,
                          height: doc.internal.pageSize.getHeight(),
                          margin: [110, 80, 60, 35],
                          windowWidth: 1000,
          ...
          <>
            ...
            <form>
              <div className={geninfoTab ? "customtab" : "d-none"}>
                ...
                <div class={applicationDetail?.applicationStatus == 0 ? "d-none" : "row"}>
                  <div class="col-md-6">
                ...
                {applicationDetail?.fileName || applicationDetail?.filePath ? (
                  <div className={applicationDetail?.filePath != null  ? "attachemt_form-bx" : "d-none"}>
                    <label
                      style={{
                        background: "#d9edf7",
                        padding: "9px 3px",
              ...
              <div className={banksuperTab ? "customtab" : "d-none"}>
                ...
                <div className="row">
                  ...
                  <div className="col-md-6">
                    ...
                    >
                      <label className="controlform">Delegate</label>
                      <div className="row">
                        <div className="col-md-12 my-2">
                          <input
                            ...
                            style={{ width: "18px" }}
                            checked={nextlevelvalue == 20 ? true : false}
                          />
                        </div>
                      </div>
                    </div>
                ...
                <div className="row mt-2">
                  ...
                  <div className="col-md-12">
                    {checkSupervisor == false && roleID == 3 && nextlevelvalue == 20 ? (
                      <>
                        <div className="inner_form_new">
                          <label className="controlform">
                            User
                          ...
                          <div className="form-bx">
                            <label>
                              ...
                              <span className="sspan"></span>
                              {errors.Descsupervisruser && !AssignUserID ? (
                                <small className="errormsg">
                ...
                {checkSupervisor == false && roleID == 3 && nextlevelvalue == "" ? (
                  <>
                    <div
                      className={
                        checkSupervisor == false && roleID == 3
    ...
    {errors.assignedTo && !SupervisorRoleId ? (
      ...
      /> */}
                            ...
                            {index == 0 ? (
                              <>
                                <div>
                                  ...
                                  >
                                    <h3 className="pdfwatermark">Preview</h3>
              ...
              <div className="form-footer mt-5 mb-3">
                ...
                <div>
                  {(roleID > 5 && recomdAnalyst == "121") || (roleID == 3 && applicationstaus && applicationstaus != 0) ? (
                    <>
                      <button
                        type="button"
                  ...
                  <button
                    ...
                    disabled={
                      ((applicationstaus == 3 ||
                        ...
                        ((applicationstaus == "0" || applicationstaus == "") && roleID == 5) ||
                  ...
                  >
                    {(roleID > 5 &&
                      ...
                      nextlevelvalue != "35" &&
                      recomdAnalyst == "121") ||
                      (roleID == 3 && checkSupervisor == false && nextlevelvalue == "")
                      ? "Submit & Close"
                      : "Submit"} {SubmitBtnLoader == true ? <div className="smallloader"></div> : ""}
                  </button>
                </div>
              </div>
                      ...
                      <tr>
                        ...
                        >
                          ...
                          {applicationDetail?.bankAddress3 !=
                            ...
                            : ""}
                          <br />
                          <span style={{ borderBottom: "1px solid #000", fontWeight: "800", fontSize: "18px", }}
                            className="text-uppercase"
                          >
                              ...
                              <td colSpan="2">
                                <table width="100%">
                                  <tr>
                                    ...
                                    >
                                      <div><span style={{ fontWeight: "800", padding: "15px 0px 15px" }}>Response &nbsp;/&nbsp; Conditions</span></div>
                                      <div
                                        dangerouslySetInnerHTML={{
                                          __html: Description
                                            ? Description
                              ...
                              <td colSpan="2">
                                <table width="100%">
                                  <tr>
                                    ...
                                    >
                                      <div><span style={{ fontWeight: "800", padding: "15px 0px 15px" }}>Notes &nbsp;/&nbsp; Description</span></div>
                                      <div
                                        dangerouslySetInnerHTML={{
                  ...
                  > 
                    ...
                    <table width='100%' >
                      <tr>
                        ...
                        >
                           <h3 style={{position: "absolute", width:"50%", fontSize:"132px", color:"#edededfa", right:"60px",   top:"18%", opacity:"0.02"}}>Preview</h3>
                          Exchange &nbsp; Control &nbsp; Ref
                          <br />
                          Previous &nbsp; Exchange &nbsp; Control &nbsp; Ref
                        </td>
