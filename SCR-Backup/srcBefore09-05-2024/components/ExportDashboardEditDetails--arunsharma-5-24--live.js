...
const ExportDashboardEditDetails = ({
  ...
  }, [editor,editorAnalyst,editorSrAnalyst,editorPrincipleAnalyst,editorDeputy,editorDirector]);
      ...
      axios
          ...
          .then((response) => {
            ...
            if (response.data.responseCode === "200") {
              ...
              const refpdfview = roleID == 3 ? PdfPrivewsupervisorRef :PdfPrivewRef;
              doc.html(refpdfview.current, {
                ...
                async callback(doc) {
                  ...
                  //window.open(URL.createObjectURL(blob), 'http://localhost:3001/BankADLADashboard', windowFeatures);
                  //window.open(<iframe src="URL.createObjectURL(blob)" width="540" height="450"></iframe>)
                },
              });
              setBtnLoader(false);
  ...
  const validateForm = () => {
    ...
    if ( AssignUserID == "" && (nextlevelvalue == "20" || nextlevelvalue == "10")  &&  roleID == 5 && checkSupervisor == true ) {
    ...
    if (
      (Description == "" ||  Description == "<p></p>" ) && applicationDetail?.analystDescription == null && roleID >= 5
    ) {
    ...
    if (
      ...
      ( Description == null || Description == "<p></p>"  && roleID == 3 && nextlevelvalue == "" && nextlevelvalue != "20") 
      || (nextlevelvalue == "10" &&   Description == "<p></p>" && roleID == 3 && nextlevelvalue != "20" ) 
      || (Description == "<p></p>"  && supervisordecision == true && roleID == 3 && nextlevelvalue != "20")
    ) {
                      ...
                      <label>
                        <input
                          ...
                          value={
                            roleID == 2
                              ? bankName.replace(/"/g, "")
                              : applicationDetail?.bankName ? applicationDetail?.bankName : "N/A"
                          }
                          disabled
                        />
                        <span className="sspan"></span>
                                ...
                                <>
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <div className="form-bx">
                                        <div
                                          className="tableEditorData analyst_desc"
                            ...
                            >
                              ...
                              <div className="form-bx">
                                <label>
                                  ...
                                  <span className="sspan"></span>
    {errors.frequency && getFrequencyID == "0" && IsReturn =="1"  ? (
      <small className="errormsg">
        {errors.frequency}
      </small>
    ) : (
                                      ...
                                      <div className="form-bx">
                                        <label>
                                          <div
                                            ...
                                            className="disabled tableEditorData"
                                          />
                                        </label>
                                      </div>
                                    </div>
    ...
    {errors.frequency && getFrequencyID == "0" && IsReturn =="1"  ? (
      ...
      ""
                                ...
                                <div>
                                  ...
                                  : applicationDetail?.companyName}
                                            ...
                                            <tr>
                                              ...
                                              >
                                                : {applicationstaus == "10" ? "Approved" : applicationstaus == "30" ? "Rejected" : applicationstaus == "40" ? "Deferred " : applicationstaus == "25" ? "Cancelled" : ""}   
                                                {/* {applicationDetail?.statusName} */}
                                              </td>
                                            </tr>
                                            <tr>
                                              ...
                                              <td colSpan="2" className="p-0">
                                                <table width="100%">
                                                  <tr>
                                                    ...
                                                    >
                                                      <div
                                                        className="header_content tableEditorData"
                                                        dangerouslySetInnerHTML={{
                                                          __html: Description
                                                            ? Description
                                                            : applicationDetail?.analystDescription,
              ...
              <div className="form-footer mt-5 mb-3">
                ...
                <div>
                  {(roleID > 5 && recomdAnalyst == "121" && applicationstaus != "25") ||
                  (roleID == 3 && applicationstaus && applicationstaus != 0 && applicationstaus != "25") || (roleID == 3 &&  nextlevelvalue == "10" && applicationstaus != "25") ? (
                    <>
                      <button
                        type="button"
                      ...
                      <tr>
                        <td colSpan="2">
                          <table width="100%">
                            ...
                            <tr className={applicationDetail?.expiringDate == null || applicationDetail?.expiringDate == ""  ? "d-none" : ""}>
                              <td
                                style={{
                                  color: "#000",
                                  fontSize: "18px",
                            ...
                            <tr className={applicationDetail?.returnFrequencyName ==
                                  null ||
                                applicationDetail?.returnFrequencyName == "" ? "d-none" : "" }>
                              <td
                                style={{
                                  fontSize: "18px",
                                  fontWeight: "400",
                    ...
                    <table width="100%">
                      ...
                      <tr>
                        ...
                        >
                          The Head - Exchange Control
                          <br />
                          {applicationDetail?.bankName ?  applicationDetail?.bankName : ""}
                          {applicationDetail?.bankName == null ? <span>Reserve Bank of Zimbabwe. 80 Samora Machel Avenue, <br /> P.O. Box 1283, Harare, Zimbabwe.</span>
                          :
                          <>
                          <br />
                        { applicationDetail?.bankAddress1 != null ||
