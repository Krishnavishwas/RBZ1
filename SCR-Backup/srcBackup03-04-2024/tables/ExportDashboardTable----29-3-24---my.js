  ...
  const action = (rowData) => {
    return (
      <>
        <i
          className="pi pi-eye"
          style={{ padding: "10px 5px", marginRight:"10px", cursor: "pointer" }}
          onClick={() => {
    ...
    <>
      {loading == false && data?.length === 0 ? (
        ...
        <>
          ...
          /> 
          */}
          {loading == true ? <label className='outerloader2'> <span className="loader"></span><span className='loaderwait'>Please Wait...</span></label>:
          <div>
            ...
            <DataTable
              ...
              emptyMessage={data?.length == 0 ? "No Data found." : ""}
              header={header}
            >
              <Column
