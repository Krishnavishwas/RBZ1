...
const ExportDashboardTable = () => {
  ...
  const renderHeader = () => {
    return (
      <div className="d-flex justify-content-between align-items-center">
        ...
        {roleID >= 5 && selectedAppliation?.length ? (
          <div
  ...
  console.log("showdataLoader", showdataLoader)
          ...
          {loading == true ? (
            ...
            <div>
              <DataTable
                ...
                scrollable
                scrollHeight="500px"
                className={roleID >= 5 ? "mt-1" : "mt-1 tablehideth"}
          ...
          >
            <div className="application-box">
              <div className="login_inner">
                ...
                <div className="login_form_panel" style={{minHeight:'500px'}}>
                  <Modal.Body className="p-0">
