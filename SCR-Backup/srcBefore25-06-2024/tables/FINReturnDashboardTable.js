...
import ReturnImportDashboardEditDetails from "../components/ReturnImportDashboardEditDetails";
import ReturnFINDashboardViewDetails from "../components/ReturnFINDashboardViewDetails";

const FINReturnDashboardTable = () => {
            ...
            <div className="login_form ">
              <h5>
                <Modal.Header closeButton className="p-0">
                  <Modal.Title>
                    View Return Foreign Investments Request --{" "}
      ...
      >
        <div className="application-box">
          <div className="login_inner">
                ...
                <Modal.Header closeButton className="p-0">
                  <Modal.Title style={{ width: "100%" }}>
                    <div className="row">
                      ...
                      >
                        Edit Return Foreign Investments Request --{" "}
                        <big>
            ...
            <div className="login_form_panel">
              <Modal.Body className="p-0">
                <ReturnImportDashboardEditDetails
                  applicationDetail={applicationDetail}
...
export default FINReturnDashboardTable;
