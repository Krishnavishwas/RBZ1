    ...
    const HandleSubmit = async (e) => {
        ...
        if (validateForm()) {
            ...
            if (selectedStatusValue.length > 0) {
                wherecondition += " AND Sector IN(" + selectedStatusValue.join() + ")";
            }
    ...
    return (
        <>
            <form className="bankReportForm">
                                ...
                                <div className="form-bx-datePicker">
                                    <DatePicker
                                        ...
                                        onChange={(date) => {
                                            ...
                                            updatedFromDate.setDate(updatedFromDate.getDate() + 365);
                                            setFromDate(date);
                                        }}
                                        peekNextMonth
                ...
                <ExportBankReportTable bankReportResData={bankReportResData} />
                {/* table data show end */}
                {/* {updatepopup == true ? (
                    <UpdatePopupMessage
                        heading={heading}
