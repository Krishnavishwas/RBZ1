...
const [othersharefile, setOthersharefile] = useState([]);
  ...
  useEffect(()=>{
    setIsReturn(applicationDetail?.isReturnNeeded ? `${applicationDetail?.isReturnNeeded}` : "0");
    setIsReturnOption(applicationDetail?.isReturnNeeded ? `${applicationDetail?.isReturnNeeded}` : "0");
    setGetFrequencyID(applicationDetail?.returnFrequencyType ? `${applicationDetail?.returnFrequencyType}` : "0") ;
    setIsReturnExpiringDate(applicationDetail?.returnDate ? applicationDetail?.returnDate : new Date()) ;
...
setExpiringDate(applicationDetail?.expiringDate ? applicationDetail?.expiringDate : new Date())
...
setSelectedBanks(bankdtata)
  ...
  const handleFIleview = ()=>{
    axios.post(APIURL + "ExportApplication/GetSharedFileData", {
  ...
  const handleRemovfile = (id) => { 
    ...
    axios.post(APIURL + "File/DeleteFile",{
      ID : id
    })
    .then((res)=>{ 
      handleFIleview(); 
      ...
      await axios
        ...
        .then(async (res) => {
          ...
          if (res.data.responseCode === "200") { 
            ...
            for (let i = 0; i < userfiles?.length; i++) { // Corrected loop condition
              formData.append("files", userfiles[i].file); 
            }
            formData.append("ApplicationActivityID", res.data.responseData?.applicationActivityID);
            formData.append("RBZReferenceNumber", applicationDetail?.rbzReferenceNumber);
            ...
            .catch((err)=>{
              ...
              axios.post(APIURL + "ExportApplication/CopyingResponses", copyresponse).then((resposnse)=>{
              ...
              for (let i = 0; i < sharefile?.length; i++) { // Corrected loop condition
                shareformData.append("files", sharefile[i].file); 
                shareformData.append("fileInfoID", sharefile[i].fileInfoID)
              }
              shareformData.append("RBZReferenceNumber", applicationDetail?.rbzReferenceNumber); 
              ...
              axios.post(ImageAPI + 'File/UploadSharedDocs',shareformData).then((res)=>{
  ...
  const CCValue = applicationDetail?.copiedResponses?.length ? applicationDetail?.copiedResponses?.map((v,i)=> <li key={i}>{v.bankName}</li>) : null;
  ...
  return (
    <>
      ...
      {!tatHistory?.length || showdataLoader == true || !noDataComment?.length   ? (
                ...
                <div className="form-bx">
                  <label>
                    <input
                      ...
                      value={applicationDetail?.applicantReferenceNumber ? applicationDetail?.applicantReferenceNumber : "N/A"}
                      disabled={roleID == 2 || roleID == 3 ? false : true}
                    />
                    <span className="sspan"></span>
                    {errors.applicantReferenceNumber ? (
                  ...
                  return (
                    <div className="attachemt_form-bx" key={items.id}>
                      ...
                      <span className="filename">
                        ...
                        {/* {items?.filePath && items.filePath.endsWith(".pdf") ?  
   <a href={items.filePath} target="_blank" rel="noopener noreferrer"> 
      <iframe src={items.filePath} style={{ height: "60px", width: "70px" }} title="PDF" />
   </a> : 
   <Link to={items?.filePath} target="_blank" >  
      <img src={items?.filePath} style={{maxHeight:"90px"}} alt="Preview" />
   </Link>
}   */}
                      </span>
                    </div>
            ...
            {/* -------------start next level------- */}
                ...
                >
                  ...
                  {
              responceCount?.map((item, i)=>{if(item?.id == 3)return(<>{item?.count == 0 ? "" : <span className="counter-tab">{item?.count}</span> }</>)})
            }
                  <span className="btn-collapse">
                    <i className="bi bi-caret-down-fill"></i>
                  </span>
  ...
  if(data.roleID == 3 && data.isDataAvailable == 0) {
    return (
      <div className={banksuperTab && roleID !=3  ? "customtab" : "d-none"} key={i}>
                  ...
                  {/* Now no need if supervisor sending the application to record officer no need to select any user Added by Arun*/}
                   ...
                   {checkSupervisor == false && roleID == 3 ? (
                    <>
                      <div
                        className={
                          (checkSupervisor == false && roleID == 3) ? "inner_form_new align-items-center"
                            : "d-none"
                        }
                      >
                        ...
                        <div className="row">
                          <div className="col-md-12 position-relative">
                           ...
                           {errors.supervisordecision && applicationstaus == "" ? <small className="error-decision">{ errors.supervisordecision}</small> : ""} 
                          </div>
                        </div>
                      </div>
            ...
            {roleID >= 4 ? (
              <>
                ...
                >
                  Record Officer{" "}
                  {
              responceCount?.map((item, i)=>{if(item?.id == 4)return(<>{item?.count == 0 ? "" : <span className="counter-tab">{item?.count}</span> }</>)})
            }
                  <span className="btn-collapse">
                    <i className="bi bi-caret-down-fill"></i>
                  </span>
  ...
  if(data.roleID == 4 && data.isDataAvailable == 0) {
    return (
      <div className={recordTab && roleID !=4  ? "customtab" : "d-none"} key={i}>
        <div className="text-center">No Data Found</div>
      </div>
    );
  }
                          ...
                          <label>
                            ...
                            >
                              ...
                              {getalluser?.map((item, index) => {
                                return (
                                  <option key={index} value={item.userID} selected={AssignUserID == item.userID ? true :  false}>
                                    {item.name} 
                                  </option>
                                );
                              })}
            ...
            {roleID >= 4 ? (
              <>
                ...
                >
                  ...
                  Analyst{" "}
                  {
              responceCount?.map((item, i)=>{if(item?.id == 5)return(<>{item?.count == 0 ? "" : <span className="counter-tab">{item?.count}</span> }</>)})
            }
                  <span className="btn-collapse">
                    <i className="bi bi-caret-down-fill"></i>
                  </span>
                                          ...
                                          <input
                                            ...
                                            value={
                                              ...
                                              firstItem?.actionStatusName ==
                                                "Reject" ||
                                              firstItem?.actionStatusName ==
                                                "Cancelled" || firstItem?.actionStatusName ==
                                                "Draft"
                                                ? "Assigned"
                                                : firstItem?.actionStatusName
                                            }
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="browse-btn">
                              ...
                              <input
                                type="file"
                                onChange={(e) => handleuserFileChange(e, "analyst" + index)}
                              />
                            </div>
                            <span className="filename">
                              {userfiles?.find((f) => f.id === "analyst" + index)?.file
                                ?.name || "No file chosen"}
                            </span>
                            {userfiles?.length && userfiles?.find((f) => f.id === "analyst" + index)?.file
          ?.name ?  <button type="button" className="remove-file" onClick={() => removeUserImage(index, "analyst" + index)}>Remove</button> : "" }
                          </div>
                        );
                      })}
                      ...
                      {otheruserfiles.map((file, index) => (
                        ...
                        >
                          ...
                          { userfiles?.length && userfiles?.find((f) => f.id === "other" + (index))?.file
          ?.name ?  <button type="button" className="remove-file" onClick={() => removeUserImage(index, "other" + (index))}>Remove</button> : "" }
...
<div className=" cccto" ><div className="flex justify-content-center multiSelect">
<MultiSelect
          value={selectedBanks}
...
{/* <MultiSelect
                      ...
                      >
                        ...
                        <div className="hidden-toggles">
                          <input
                            ...
                            value="1"
                          />
                          <label for="exprqana" className="hidden-toggles__label">
                            Yes
                          </label>
                          <input
                            type="radio"
                          ...
                          />
                          <label for="noexpana" className="hidden-toggles__label">
                            No
                          </label>
                        </div>
                      </div>
                              ...
                              <>
                                            ...
                                            <label>
                                              <input
                                                ...
                                                value={
                                                  ...
                                                  item?.actionStatusName ==
                                                    "Cancelled"
                                                    ? "Assigned" || item?.actionStatusName ==
                                                    "Draft"
                                                    : item?.actionStatusName
                                                }
                                              />
                                    ...
                                    <label>
                                      <div
                                        dangerouslySetInnerHTML={{
                                          __html: applicationDetail?.analystRecommendationName,
                                        }}
                                        className="disabled"
                                        disabled
                                      />
                               ...
                               <div className="inner_form_new align-items-start mt-2">
                                ...
                                >
                                  ...
                                  <div className="inner_form_new "><label className="controlform">Attachments</label>
                                  
                                  <div className="form-bx">
                                  {item?.filesData?.length ? item?.filesData?.map((items, index) => {
                  return (
  ...
  {CCValue}
                                  ...
                                  {item.isReturnNeeded == 1 && item?.returnFrequencyType == 1 && item?.returnFrequencyName == "Once" ? (
                                    <div class="row">
                                      <div class="col-md-7"
                                      >
                                  ...
                                  item.isReturnNeeded == 1 &&  item?.returnFrequencyType !== 1 ? (
                                    <div
                                      class="col-md-12"
                                    >
                                      <div class="inner_form_new align-item-center">
  ...
  if(data.roleID == 5 && data.isDataAvailable == 0) {
    return (
      <div className={analystTab && roleID !=5  ? "customtab" : "d-none"} key={i}>
        <div className="text-center">No Data Found</div>
      </div>
    );
  }
            ...
            {roleID >= 4 ? (
              <>
                ...
                >
                  Senior Analyst{" "}
                  {
              responceCount?.map((item, i)=>{if(item?.id == 6)return(<>{item?.count == 0 ? "" : <span className="counter-tab">{item?.count}</span> }</>)})
            }
                  <span className="btn-collapse">
                    <i className="bi bi-caret-down-fill"></i>
                  </span>
  ...
  if(data.roleID == 6 && data.isDataAvailable == 0) {
    return (
      <div className={sranalystTab && roleID !=6  ? "customtab" : "d-none"} key={i}>
        <div className="text-center">No Data Found</div>
      </div>
    );
  }
                                        ...
                                        <label>
                                          ...
                                          <input
                                            ...
                                            value={
                                              ...
                                              firstItem?.actionStatusName ==
                                                "Cancelled"
                                                ? "Assigned" || firstItem?.actionStatusName ==
                                                "Draft"
                                                : firstItem?.actionStatusName
                                            }
                                          />
...
/> */}
                      ...
                      >
                        ...
                        <div className="hidden-toggles">
                          <input
                            ...
                            value="1"
                          />
                          <label for={defaultnoExpiry == "1" ? "" : "exprqsr" } className="hidden-toggles__label">
                            Yes
                          </label>
                          <input
                            type="radio"
                            ...
                            checked={defaultnoExpiry == "0"}
                          />
                          <label for={defaultnoExpiry == "0" ? "" : "noexpsr"} className="hidden-toggles__label">
                            No
                          </label>
                        </div>
                      </div>
            ...
            {roleID >= 4 ? (
              <>
                ...
                >
                  Principal Analyst{" "}
                  {
              responceCount?.map((item, i)=>{if(item?.id == 7)return(<>{item?.count == 0 ? "" : <span className="counter-tab">{item?.count}</span> }</>)})
            }
                  <span className="btn-collapse">
                    <i className="bi bi-caret-down-fill"></i>
                  </span>
  ...
  if(data.roleID == 7 && data.isDataAvailable == 0) {
    return (
      <div className={principalanalystTab && roleID !=7 ? "customtab" : "d-none"} key={i}>
        <div className="text-center">No Data Found</div>
      </div>
    );
  }
...
<div className="hidden-toggles">
  <input
    ...
    value="1"
  />
  <label for="exprqprs" className="hidden-toggles__label">
    Yes
  </label>
  <input
    type="radio"
    ...
    checked={defaultnoExpiry == "0"}
  />
  <label for="noexpprs" className="hidden-toggles__label">
    No
  </label>
</div>
</div>
...
<div className="col-md-5">
                                              ...
                                              <input
                                                ...
                                                value={
                                                  ...
                                                  item?.actionStatusName ==
                                                    "Reject" ||
                                                  item?.actionStatusName ==
                                                    "Cancelled" || item?.actionStatusName ==
                                                    "Draft"
                                                    ? "Assigned"
                                                    : item?.actionStatusName
                                                }
            ...
            {roleID >= 4 ? (
              <>
                ...
                >
                  Deputy Director{" "}
                  {
              responceCount?.map((item, i)=>{if(item?.id == 8)return(<>{item?.count == 0 ? "" : <span className="counter-tab">{item?.count}</span> }</>)})
            }
                  <span className="btn-collapse">
                    <i className="bi bi-caret-down-fill"></i>
                  </span>
  ...
  if(data.roleID == 8 && data.isDataAvailable == 0) {
    return (
      <div className={deputyTab && roleID !=8 ? "customtab" : "d-none"} key={i}>
        <div className="text-center">No Data Found</div>
      </div>
    );
  }
...
<div className="hidden-toggles">
  <input
    ...
    value="1"
  />
  <label for={defaultnoExpiry == "1" ? "" : "exprqdp"} className="hidden-toggles__label">
    Yes
  </label>
  <input
    type="radio"
    ...
    checked={defaultnoExpiry == "0"}
  />
  <label for={defaultnoExpiry == "0" ? "" :"noexpdp"} className="hidden-toggles__label">
    No
  </label>
</div>
</div>
...
<div className="col-md-5">
            ...
            {roleID >= 4 ? (
              <>
                ...
                >
                  Director{" "}
                  {
              responceCount?.map((item, i)=>{if(item?.id == 9)return(<>{item?.count == 0 ? "" : <span className="counter-tab">{item?.count}</span> }</>)})
            }
                  <span className="btn-collapse">
                    <i className="bi bi-caret-down-fill"></i>
                  </span>
  ...
  if(data.roleID == 9 && data.isDataAvailable == 0) {
    return (
      <div className={director && roleID !=9  ? "customtab" : "d-none"} key={i}>
        <div className="text-center">No Data Found</div>
      </div>
    );
  }
...
<div className="hidden-toggles">
  <input
    ...
    value="1"
  />
  <label for={defaultnoExpiry == "1" ? "" : "exprqdr"} className="hidden-toggles__label">
    Yes
  </label>
  <input
    type="radio"
    ...
    checked={defaultnoExpiry == "0"}
  />
  <label for={defaultnoExpiry == "0" ? "" :"noexpdr"} className="hidden-toggles__label">
    No
  </label>
</div>
</div>
  ...
  {CCValue}
            ...
            {roleID >= 5 ? (
              <>
                ...
                >
                  Share File <span className="counter-tab">{viewShareFile?.length}</span>
                  <span className="btn-collapse">
                    <i className="bi bi-caret-down-fill"></i>
                  </span>
                </h5>
                ...
                <div
                  className={
                    sharefiletab ? "customtab  mt-2" : "d-none"
                  }
                >
                  {/* <label
                    style={{
...
{viewShareFile?.map((items, index) => {
                  return (
                    <div className="attachemt_form-bx" key={items.id}>
                      ...
                      <button type="button" onClick={(e)=>handleRemovfile(items.id)} className="remove-file">Remove</button>
                    </div>
                  );
                }
                )
  ...
  return (
    ...
    >
      ...
      <div className="browse-btn">
        ...
        <input
          type="file"
          onChange={(e) => handleshareFileChange(e, `sharefile ${index}`)}
        />
      </div>
      <span className="filename">
        {sharefile?.find((f) => f.id === `sharefile ${index}`)?.file
          ?.name || "No file chosen"}
      </span>

     {sharefile?.length && sharefile?.find((f) => f.id === `sharefile ${index}`)?.file
          ?.name ?  <button type="button" className="remove-file" onClick={() => removeshareImage(index, `sharefile ${index}`)}>Remove</button> : "" }
  ...
  >
    ...
    <div className="browse-btn">
      ...
      <input
        type="file"
        onChange={(e) => {
          handleshareFileChange(e, "sharefileother" + (index + 1));
          handleOthrefile(e, "sharefileother" + (index + 1));
        }}
      />
    </div>
    <span className="filename">
      {sharefile?.find((f) => f.id === "sharefileother" + (index + 1))
        ?.file?.name || "No file chosen"}
    </span>
   {
    sharefile?.length && sharefile?.find((f) => f.id === "sharefileother" + (index + 1))
    ?.file?.name  ? <button type="button" className="remove-file" onClick={() => removeshareImage(index, "sharefileother" + (index + 1))}>Remove</button> :
""
  }
  </div>
))} 
            ...
            <div className="form-footer mt-5 mb-3">
              ...
              <div>
                                      ...
                                      <table>
                                        ...
                                        <tr>
                                          ...
                                          >
                                            ...
                                            <img
                                              src={userSign ? userSign.replace(/"/g, "") : NoSign}
                ...
                >
                  ...
                  nextlevelvalue != "20" &&
                  nextlevelvalue != "35" &&
                  recomdAnalyst == "121" ||  ( roleID == 3 && checkSupervisor == false )
                    ? "Submit & Close"
                    : "Submit"}
                </button>
              </div>
