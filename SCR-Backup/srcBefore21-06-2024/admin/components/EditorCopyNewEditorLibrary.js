...
const EditorTemplate = () => {
    ...
    useEffect(() => {
        // console.log("useREF", editorRef.current.editor);
    }, []);
    useEffect(() => {
                                        ...
                                        <div className='outer-tampale-pdf'>
                                            ...
                                            <div ref={targetRef} className='template-pdf'>
                                                ...
                                                <div className='template-iiner-pdf'>
                                                    ...
                                                    <pre style={{ textAlign: `${templaesetting.paraonealign}`, fontWeight: `${templaesetting.paraoneweight}`, fontSize: `${templaesetting.paraonesize + "px"}`, lineHeight: `${templaesetting.paraonelignhight + "px"}`, margin: `${templaesetting.paraonemargin + "px"}`, color: `${templaesetting.paraonecolor}` }}><pre dangerouslySetInnerHTML={{ __html: editorValue }} /></pre>
                                                </div>
