            ...
            <>
              {dataArray?.length > 1 ? (
                    ...
                    {dataArray?.map((arrayItem, index) => {
                      return (
                        ...
                        >
                          <Header />
                          <div
                            dangerouslySetInnerHTML={{ __html: arrayItem }}
                            className="pdfGenerateContent"
                            style={{
                ...
                <div style={{ opacity: 0, height: 0 }} className="pdfmain">
                  ...
                  >
                    <div
                      className=" pdfGenerateHea2"
                      style={{ position: "relative", height: "435mm" }}
                    >
                      <Header />
                      <div
                        dangerouslySetInnerHTML={{ __html: inputString }}
                        className="pdfGenerateContent2"
                        style={{
                          padding: "20px 20px 100px",
                          height: "373mm",
                          fontSize: "16px",
