    ...
    const columns = [
        ...
        },
        {
            ...
            cell: row => <> <Link to="" className="me-2"
                ...
                {/* <Link to="" className=""
                    onClick={() => handleDeleteShow(row.id, row.name)}><i className="bi bi-trash"></i></Link> */}
                            ...
                            <div className="application-tab w-100 mt-4">
                                <ul className="nav nav-pills mb-3">
                                    <li className="nav-item">
                                        <a className={tabDepId == 1 ? "nav-link active" : "nav-link"} onClick={(e) => handleClickTag(1)}>Export</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className={tabDepId == 2 ? "nav-link active" : "nav-link"} onClick={(e) => handleClickTag(2)}>Import</a>
                                    </li>
                                    <li className="nav-item">
                                        <a className={tabDepId == 3 ? "nav-link active" : "nav-link"} onClick={(e) => handleClickTag(3)}>Foreign Investment</a>
                                    </li>
                                    <li className="nav-item">
