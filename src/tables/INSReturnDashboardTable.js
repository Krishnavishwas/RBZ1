...
import ReturnINSDashboardEditDetails from "../components/ReturnINSDashboardEditDetails";
import ReturnINSDashboardViewDetails from "../components/ReturnINSDashboardViewDetails";

const INSReturnDashboardTable = () => {
            ...
            <div className="login_form ">
              <h5>
                <Modal.Header closeButton className="p-0">
                  <Modal.Title>
                    View Return Inspectorate Request --{" "}
                ...
                <Modal.Header closeButton className="p-0">
                  <Modal.Title style={{ width: "100%" }}>
                    <div className="row">
                      ...
                      >
                        Edit Return Inspectorate Request --{" "}
                        <big>
...
export default INSReturnDashboardTable;
