...
const FINDashboardTable = () => {
  ...
  const GetApplicationCount = async (id) => {
    await axios
      .post(APIURL + "ImportApplication/CountByApplicationID", {
        ApplicationID: id,
      })
      .then((res) => {
        if (res.data.responseCode == 200) {
  ...
  const delegateSubmit = (e) => {
    ...
    setBtnLoader(true);
    axios
      .post(APIURL + "ImportApplication/BulkDelegate", delegateValues)
      .then((res) => {
        if (res.data.responseCode == 200) {
          setBtnLoader(false);
          DelegateModalClose();
...
const [showOldDataLoader, setShowOldDataLoader] = useState(false);
  ...
  const GetOldHandelDetail = async (id) => {
    ...
    await axios
      .post(APIURL + "ImportApplication/GetRequestInfoByApplicationID", {
        ID: id,
      })
      .then((res) => {
        if (res.data.responseCode === "200") {
    ...
    await axios
      .post(APIURL + "ImportApplication/GetCommentsInfoByRoleID", {
        ApplicationID: id,
      })
      .then((res) => {
        if (res.data.responseCode == 200) {
    ...
    await axios
      .post(APIURL + "ImportApplication/GetApplicationHistory", {
        ID: id,
      })
      .then((res) => {
        if (res.data.responseCode == 200) {
    ...
    await axios
      .post(APIURL + "ImportApplication/GetApplicationActionsByApplicationID", {
        ID: id,
      })
      .then((res) => {
        if (res.data.responseCode == 200) {
