...
import ReturnImportDashboardViewDetails from "../components/ReturnImportDashboardViewDetails";

const ImportReturnDashboardTable = () => {
          ...
          <div className="login_inner">
            ...
            <div className="login_form_panel">
              <Modal.Body className="p-0">
                <ReturnImportDashboardViewDetails
...
export default ImportReturnDashboardTable;
