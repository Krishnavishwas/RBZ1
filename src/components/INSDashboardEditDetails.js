...
const INSDashboardEditDetails = ({
  ...
  const HandleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      await axios
        .post(APIURL + "InspectorateApplication/UpdateInspectorateApplication", {
          ID: applicationDetail?.id,
          AssignedTo:
  ...
  const getLastComment = async (id) => {
    await axios
      .post(APIURL + "InspectorateApplication/GetLastApplicationDataByIDINS", {
        ApplicationID: id,
        RoleID: roleID,
      })
      .then((res) => {
...
export default INSDashboardEditDetails;
