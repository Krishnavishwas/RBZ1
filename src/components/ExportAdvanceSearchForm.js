...
const ExportAdvanceSearchForm = ({
    ...
    const heading = "Advance Search Save Successfully!";
    const para = "Export Advance Search Save successfully!";
    ...
    // const bankOptionnew = masterBank
    //     ?.filter(res => saveSearchBank?.includes(res.id.toString()))
    //     .map(res => ({
    //         label: res.bankName,
    //         value: res.id,
    //     }));
    // console.log("bankOption", bankOptionnew);
    ...
    // console.log("saveSearchSelectedValue", saveSearchSelectedValue);
    return (
        <>
            <form className="bankReportForm">
                                ...
                                <div className="cccto position-relative">
                                    <div className="multiselect">
                                        ...
                                        {errors?.selectedBank && selectedBank == "" ? (
                                            ...
                                            <>
                                                <span style={{ fontSize: "11px", color: "#8d8c8c", fontStyle: "italic" }}>Maximum 5 bank allowed.</span>
                                            </>
                ...
                <ExportAdvanceSearchTable advanceSearchData={advanceSearchData} />
                {/* table data show end */}
