...
const ReturnImportDashboardEditDetails = ({
  applicationDetail,
  ...
  const para = "Import returns request updated successfully!";
  ...
  const closePopupHandle = () => {
    if (menuname == "Home") {
      ...
      navigate("/ImportReturnDashboard");
    }
    EditModalClose();
    handleData();
...
export default ReturnImportDashboardEditDetails;
