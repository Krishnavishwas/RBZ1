        ...
        <div className='row'>
          <div className='col-md-12'>
            <div className='datatable'>
              ...
              {
                (RoleId == "6" || RoleId == "7" || RoleId == "8") && data?.length ? <Link to="/ActingRoleDashboard" className='act_btn-dashboard' onClick={clickhandlerole}>Acting Role <span>{data?.length}</span></Link> : ""
              }
              </h4> 
